...
For **this Screeps AI repo**, use the five parallel prompts in [references/screeps-parallel-prompts.md](references/screeps-parallel-prompts.md) instead of generic full-stack prompts when onboarding on Screeps architecture.
